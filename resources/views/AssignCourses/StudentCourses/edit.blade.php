                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="{{ url('admin/student-course-update' , $updateCourses->id) }}">
                                        @csrf
                                        <div class="form-group">
                                            <select name="course" class="form-control default-select" tabindex="-98">
                                                <option value="{{ $updateCourses->course_id }}_{{ $updateCourses->courseName }}">{{ $updateCourses->courseName }}</option>
                                        ...
                                        <div class="form-group">
                                            <select name="student" class="form-control default-select" tabindex="-98">
                                                <option value="{{ $updateCourses->student_id }}_{{ $updateCourses->studentName }}">{{ $updateCourses->studentName }}</option>

                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="{{ url('admin/teacher-course-update' , $updateCourses->id) }}">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <select name="teacher" class="form-control default-select" tabindex="-98">
                                                <option value="{{ $updateCourses->teacher_id }}_{{ $updateCourses->teacherName }}">{{ $updateCourses->teacherName }}</option>

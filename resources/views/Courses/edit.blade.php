                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="{{ url('admin/course-update' , $coursesEdit->id ) }}">
                                        @csrf
                                        <div class="form-group">
                                            <input type="text" value="{{ $coursesEdit->coursesName }}" name="course" id="course" class="form-control input-default " placeholder="Enter Course Name">
                                            @error('course')
